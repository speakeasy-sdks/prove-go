...
package authbyredirect

import (
	"AuthByRedirect/pkg/utils"
	"fmt"
	"net/http"
	"time"
)
...
type SDKOption func(*AuthByRedirect)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *AuthByRedirect) {
...
func New(opts ...SDKOption) *AuthByRedirect {
	sdk := &AuthByRedirect{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
